...
export default function Trainings() {
  ...
  useEffect(() => {
    axios
      .get(
        allChecked
          ? `https://lernigoback.herokuapp.com/api/training/getAll `
          : `https://lernigoback.herokuapp.com/api/trainings/participat/${user.id}`
      )
      .then((response) => {
        setTraining(response.data);
      });
    // socket.on('refresh', () => {
    //   axios.get(`https://lernigoback.herokuapp.com/api/training/getAll`).then((response) => {
    //     setTraining(response.data);
    //   });
    // });
  }, [allChecked]);
