...
export default function CourseDetails() {
  ...
  useEffect(() => {
    // console.log(id);
    axios.get(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/api/course/getOne/${id}`).then((response) => {
  ...
  let deleteCourse = () => {
    axios.delete(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/api/course/delete/${id}`).then((response) => {
      // setCourse(response.data);
