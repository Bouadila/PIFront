...
export default function TrainingsDetail() {
  ...
  useEffect(() => {
    (async () => {
      setIsLoading(true);
      const response = await axios.get(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/api/training/getOne/${id}`);
  ...
  const applyToTraining = (t) => {
    axios
      .put(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/api/training/participantToTraining/${training._id}/${user.id}`, {
  ...
  async function handleToken(token) {
    const response = await axios.post('https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/checkout', { token, training });
