...
export default function ChangePasswordForm() {
  ...
  useEffect(() => {
    const getUserId = async () => {
      try {
        const date = await fetch('https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/users/verify-restpassword', {
          method: 'POST',
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({ password }) => {
      ...
      try {
        const response = await fetch('https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/users/update-password', {
          method: 'POST',
