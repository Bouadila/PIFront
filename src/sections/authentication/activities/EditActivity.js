...
export default function EditActivity() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        if (validate(subject, title, limiteDate)) {
          axios.put(`https://lernigoback.herokuapp.com/eya/update/${id}`, formData).then((response) => {
  ...
  /*const onSubmit = (e) => {
    ...
    if (validate(subject, title, limiteDate)) {
      axios.put(`https://lernigoback.herokuapp.com/api/update/${id}`, formData).then((response) => {
        if (response.data.success) {
          //alert('updated')
        }
