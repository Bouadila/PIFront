...
BlogPostCardFront.propTypes = {
  post: PropTypes.object.isRequired,
  index: PropTypes.number
};

export default function BlogPostCardFront(props) {
  ...
  useEffect(() => {
    axios.get('https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/read').then((response) => {
  ...
  const deleteActivity = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/eya/delete/${id}`);
  ...
  //ancien del
  /*const deleteActivity = (id) => {
    axios.delete(`https://cors-anywhere.herokuapp.com/https://lernigoback.herokuapp.com/api/delete/${id}`);
    navigate('/dashboard/blog', { replace: true });
  };*/
